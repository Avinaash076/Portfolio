  ...
  (
    ...
    return (
      <div
        ...
        className={cn(
          "w-full max-w-sm rounded-xl border border-neutral-100 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-4 font-sans shadow-lg",
          className,
        )}
        {...props}
      >
        <div className="mb-2 flex items-start justify-between gap-2">
          <div className="flex min-w-0 items-center gap-1.5">
            <Github size={16} className="shrink-0 text-neutral-800 dark:text-neutral-200" />
            <span className="truncate text-[13px] text-neutral-600 dark:text-neutral-400">
              <span className="font-semibold text-neutral-900 dark:text-neutral-100">{owner}</span>
              <span className="text-neutral-400 dark:text-neutral-600"> / </span>
              <span className="font-semibold text-neutral-900 dark:text-neutral-100">{name}</span>
            </span>
          </div>
          <span className="shrink-0 rounded-full border border-neutral-200 dark:border-zinc-700 px-2 py-0.5 text-[9px] font-medium text-neutral-500 dark:text-neutral-400">
            Public
          </span>
        </div>
          ...
          <button
            ...
            className={cn(
              ...
              starred
                ...
                : "bg-neutral-50 dark:bg-zinc-800 text-neutral-700 dark:text-neutral-300",
            )}
          >
            <Star
              size={12}
